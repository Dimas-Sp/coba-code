...
<body class="theme-light" data-highlight="blue2">
    ...
    <div id="page">
        ...
        <div class="page-content">
            ...
            <a href="{{ url('/gur_agama') }}" class="card card-style mb-3 d-flex"
                data-card-height="100">
                <div class="d-flex justify-content-between">
                    <div class="pl-3 ml-1 align-self-center">
                        <h4 class="font-600 mb-0 pt-4">Pendidikan Agama dan Budi Pekerti</h4>
        ...
        <div id="menu-share" class="menu menu-box-bottom menu-box-detached rounded-m"
            data-menu-load="{{ url('azure') }}/menu-share.html" data-menu-height="420" data-menu-effect="menu-over">
        </div>

        <div id="menu-highlights" class="menu menu-box-bottom menu-box-detached rounded-m"
            data-menu-load="{{ url('azure') }}/menu-colors.html" data-menu-height="510" data-menu-effect="menu-over">
        </div>

        <div id="menu-main" class="menu menu-box-right menu-box-detached rounded-m" data-menu-width="260"
            data-menu-load="{{ url('azure') }}/menu-main.html" data-menu-active="nav-pages"
