...
<div id="page">
    ...
    <div class="page-content">
        ...
        <div class="page-title page-title-large">
            <h2 data-username="SMKN 4 BOGOR !!!!" class="greeting-text"></h2>
        ...
        <div class="card card-style">
            <div class="content">
                <h4 class="font-600">Selamat Datang</h4>
                <p>
                    kami akan menunjukan jadwal Pelajaranmu <b>Harap Pilih Kejuruanmu</b>
                </p>
            </div>
        </div>

        <div class="row text-center mb-3">
            <a href="{{url('/')}}/menu?kejuruan=mapel_umum" class="col-6 pr-2">
                <div class="card card-style mr-0  pt-4 mb-3">
                    ...
                    <h4 class="color-theme font-600">Mata Pelajaran Umum</h4>
            ...
            <a href="{{url('/')}}/menu?kejuruan=mapel_produktif" class="col-6 pl-2">
                <div class="card card-style ml-0 mb-3 pt-4">
                    ...
                    <h4 class="color-theme font-600">Mata pelajaran Produktif</h4>
                    <p class="mt-n2 font-11 color-highlight">
                        --
                    </p>
                    <p class="font-10 opacity-30 mb-1">Tap to View</p>
            ...
            <!-- <a href="{{url('/')}}/menu?kejuruan=tkj" class="col-6 pr-2">
                <div class="card card-style mr-0 mb-3  pt-4">
                    <h1 class="center-text pt-4">
                        <i data-feather="file"
                           data-feather-line="1"
                           data-feather-size="50"
                    ...
                    <h4 class="color-theme font-600">TKJ</h4>
                    <p class="mt-n2 font-11 color-highlight">
            ...
            <a href="{{url('/')}}/menu?kejuruan=tfl" class="col-6 pl-2">
                <div class="card card-style ml-0 mb-3 pt-4">
                    <h1 class="center-text pt-4">
                    ...
                    <h4 class="color-theme font-600">Welding/TFLM</h4>
                    <p class="mt-n2 font-11 color-highlight">
                        Welding / Fabrikasi
                    </p>
                    <p class="font-10 opacity-30 mb-1">Tap to View</p>
            ...
            <!-- <a href="page-contact.html" class="col-6 pr-2">
                <div class="card card-style mr-0 mb-3  pt-4">
                    <h1 class="center-text pt-4">
                        <i data-feather="mail"
                           data-feather-line="1"
                    ...
                    <h4 class="color-theme font-600">Contact</h4>
                    <p class="mt-n2 font-11 color-highlight">
                        Walkthrough & Splash
                    </p>
                    <p class="font-10 opacity-30 mb-1">Tap to View</p>
            ...
            <a href="tel:+1 234 567 8991" class="col-6 pl-2">
                <div class="card card-style ml-0 mb-3  pt-4">
                    <h1 class="center-text pt-4">
                    ...
                    <h4 class="color-theme font-600">Call Now</h4>
                    <p class="mt-n2 font-11 color-highlight">
                        Modal Menus & Actions
                    </p>
                    <p class="font-10 opacity-30 mb-1">Tap to View</p>
